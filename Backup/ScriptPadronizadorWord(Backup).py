...
from ScriptPadronizadorAuxiliar(Backup) import ler_abreviacoes, padronizar_nome, formatar_tabela, adicionar_estilo_titulo, adicionar_quebra_pagina
...
def aplicar_padronizacao(caminho_abreviacoes, caminho_planilha, caminho_saida):
    ...
    # Imprimir as colunas do DataFrame para verificar se 'COLUMN BUSINESS NAME' está presente
